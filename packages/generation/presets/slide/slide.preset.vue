<template>
  <primitive-slide v-bind="props" @on-click="onClick">
    ...
    <p v-if="i18nEyebrow" v-html="i18nEyebrow" :class="$style.eyebrow" />
...
const { title, description, list, eyebrow } = toRefs(props);
...
const i18nEyebrow = i18n.useTranslated(eyebrow);
